...
```
Simular cien mil valores variable suma: como son independientes, se simula cada variable aleatoria por separado y se calcula su media
...
En el corte, existe una gran variabilidad dentro de cada una de las categorías pero muy poca entre ellas.
...
En la limpieza, la variabilildad del precio parece ser mayor para los que menos limpios son, no obstante, en todas las categorías la variabilidad es bastante amplia.
